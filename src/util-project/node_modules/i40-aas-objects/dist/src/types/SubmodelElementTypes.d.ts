...
import { TAnnotatedRelationshipElementJSON, AnnotatedRelationshipElement } from '../referables/AnnotatedRelationshipElement';
...
declare type TSubmodelElements = TDataElemets | SubmodelElementCollection | Operation | RelationShipElement | AnnotatedRelationshipElement | BasicEvent | Entity;
declare type TSubmodelElementsJSON = TDataElemetsJSON | TSubmodelElementCollectionJSON | TOperationJSON | TRelationShipElementJSON | TAnnotatedRelationshipElementJSON | TEntityJSON | TBasicEventJSON;
